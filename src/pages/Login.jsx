...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // 2. Firestore'dan kullanıcının ek bilgilerini çek (DOB vs.)
      ...
      if (docSnap.exists()) {
        ...
        // Eski kullanıcıysa veya dokümanı yoksa sadece emaili kaydet
  ...
  return (
    <div className="min-h-screen w-full bg-[#080B14] flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      {/* Background Effects */}
      <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-dream-accent/20 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-4 border border-white/10">
            <Lock className="text-dream-accent" size={28} />
          </div>
          <h1 className="text-3xl font-light text-white tracking-widest mb-2">Hoş Geldin</h1>
          <p className="text-sm text-dream-accent/70 font-light">Rüyalarına geri dön</p>
        </div>
        ...
        <p className="text-center text-xs text-white/50 mt-6">
          ...
          <Link to="/register" className="text-dream-accent hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </motion.div>
